          ...
          <div className='row'>
            <div className='col-md-6'>
              <div className='testimonial-card p-3 rounded text-center'>
                ...
                <p className='mt-4 mb-3'>"I recently used ParkSense, a parking booking website, and I was thoroughly impressed with the service. The Rent-A-Spot website was user-friendly and easy to navigate, allowing me to quickly find and book a parking spot for my trip. The process was seamless, and I received a confirmation email from Rent-A-Spot with all the necessary details. On the day of my arrival, the Rent-A-Spot parking lot was well-maintained and had ample space. I highly recommend Rent A Spot to anyone in need of convenient and reliable parking options."</p>
                <span><strong>Harsh Gujral</strong> (Standup Artist)</span>
              </div>
            </div>
            <div className='col-md-6'>
              <div className='testimonial-card p-3 rounded text-center'>
                {/* <img src='./profile-1.webp' /> */}
                <p className='mt-4 mb-3'>"I cannot express how grateful I am for ParkSense, the parking booking website.Parking-Zone has made the process incredibly convenient and stress-free.With few click, I can compare prices and book a parking spot in advance.Parking-Zone provides detailed information about each parking facility, including reviews from other users, which helped me make informed decisions. On multiple occasions, I arrived at my destination to find a reserved spot waiting for me, thanks to Parking-Zone. This website is a game-changer for travellers like me"</p>
                <span><strong>Rahul Rathore</strong> (Axis Bank Student Neemrana)</span>
              </div>
            </div>
          </div>
        </section>
